...
class UiMainWindow(object):
    def setup_ui(self, main_window) -> None:
        ...
        self.comboButton = QtWidgets.QComboBox(self.centralwidget)
    ...
    def text_ui(self, main_window) -> None:
        ...
        # self.comboButton.addItems(['выбор региона'] + get_region())  # получение списка с сайта hh.ru
        self.comboButton.addItem('Россия: 113')
        self.comboButton.addItems(['выбор региона'] + area)  # список из файла area.py
