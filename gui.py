...
class UiMainWindow(object):
    def setup_ui(self, main_window) -> None:
        ...
        self.label_10.setGeometry(QtCore.QRect(125, 32, 110, 35))
        ...
        self.checkbox_11.setGeometry(QtCore.QRect(205, 65, 20, 20))
